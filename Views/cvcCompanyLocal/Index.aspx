...
Inherits="System.Web.Mvc.ViewPage(Of Adasoft.WebPos.Models.cmlTCNMComp)" %>
...
var tW_Controller ='cvcCompanyLocal';
...
//            return !(window.event && window.event.keyCode == 13);
    ...
    function W_FRMtGenCode(){
        JS001_GETtAutoGenCode('cvcCompanyLocal','C_Create_GetAutoCode',document.getElementById('FTCmpCode'));
    }
    ...
    function W_DATbBrowseData(ptCase,ptObjID,ptObjName) 
    {
            ...
            var tReturnedValue = showModalDialog('<%=Url.Action("C_BRWxMaster","cvcCompanyLocal") %>' + '?ptCase=' + ptCase + '&ptDate=' + tDate, "Passed String", "dialogWidth:800px; dialogHeight:500px; status:no; center:yes;titlebar =0")
...
//        window.location = tUrl;
   ...
   function W_Clear_logo() {
       J003_SHWxWaiting();
       window.location = '<%=Url.Action("Index","cvcCompanyLocal")%>' + '?C_logo=1';
   }

   function W_Clear_map() {
       J003_SHWxWaiting();
       window.location = '<%=Url.Action("Index","cvcCompanyLocal")%>' + '?C_map=1';
   }
...
<%  Using Html.BeginForm("C_DATxSaveData", "cvcCompanyLocal", FormMethod.Post, New With {.collection = "cmlCompany", .ptValue = "Company", .name = "wCompany", .id = "wCompany", .enctype = "multipart/form-data"})%>
...
<script language="javascript" type="text/javascript" >
    ...
    $("#ocmUpLoadFile").click(function() {
            ...
            $("#wCompany").attr("action", '<%=Url.Action("C_DATxSaveImage","cvcCompanyLocal") %>');
            //alert(565);
        ...
        $("#ocmUploadMap").click(function() {
            ...
            $("#wCompany").attr("action", '<%=Url.Action("C_DATxSaveCompanyMap","cvcCompanyLocal")%>');
