    ...
    <tr style="height:160px">
        ...
        <tr>
            <td colspan="3" align="right">
                ...
                <input type="button" value='<%=ViewData("olaOK") %>' onclick="W_GETxSelectedDoc('1');" id="ocmSelDoc"/>
                <input type="button" value='<%=ViewData("olaCancel") %>' onclick="W_GETxSelectedDoc('2')" id="ocmCancelDoc" />
            </td>
        </tr>
    </tr>
<!-- Detail -->
...
<script type="text/javascript">
    ...
    function W_GETxSelectedDoc(ptFlag){//ptFlag 1 : Ok, 2 : Cancel
        try{
            switch (ptFlag) {
                case '1' : W_PRCxSelectedDoc(); break;
                case '2' : W_FRMxCloseBrwDocPo(); break;
            }
