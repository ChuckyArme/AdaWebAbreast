...
<table style="text-align:center; width:100%" border="0" cellpadding="0" cellspacing="0" >
    ...
    Dim tHidden(9) As String
            ...
            Dim nHeightGrid As Integer = 400
    ...
    gridBuilderPdt.Scrollable(Function(o) o.Height(nHeightGrid))
    ...
    <tr>
        ...
        <td align="right" valign="middle">
            ...
            <input type="button" value='<%=ViewData("olaCancel") %>' id='ocmCloseBrwPdt' onclick='W_CLSxCloseBrwPdt("2")'/>
        </td>
    </tr>
</table>
<script type="text/javascript">
    var nOnclick=0;          
    var tW_PdtCodeBe4Upd;
    ...
    function C_SETxProductData(){
        ...
        if ($('#otbPdtCode').val() != tW_PdtCodeBe4Upd) {
            $('#otbSeq').val('');
        }
        else {
            return false;
        ...
        W_CLSxCloseBrwPdt('1'); //ปิดหน้าต่างค้นหา โดยที่หน้าที่เรียกต้องมี Function นี้ด้วย
        $('#otbPdtCode').focus();
        W_CHKxPdtSerial();
    }
