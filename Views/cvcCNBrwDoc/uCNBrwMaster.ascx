...
<%                                          
    ...
    Dim nHeigthGrid As Integer = 450
        ...
        <tr>
            ...
            <td style="text-align:center">
                <input id="ocmCancelData" type = "button" 
                    ...
                    class="xCN_DivDisplayNone"
                    style="width:55px;" />
                    
                <input id="ocmSelectData" type = "button"  
                    value = '<%=ViewData("olaOK") %>' 
                    onclick = "W_SETxSelectedDataMaster(tW_Case,'1')" 
                    style="width:55px;" />
            </td>
        </tr>
    ...
    <script type="text/javascript">
        ...
        function GridMaster_onLoad() {
            ...
            $('#GridBrwMas tr', this.element).live('dblclick', function(e) {
                ...
                if(tW_StaSelect == 'N'){ W_SETxSelectedDataMaster(tW_Case,'1'); tW_StaSelect = 'Y';}
            });
