...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        ViewData("olaSplCode") = AdaWebPos.My.Resources.resLCcvcTACTPoHD.olaSplCode
    ...
    <div id="odiMain" class ="xCN_AllFontFamily xCN_AllFontSize xCN_AllFontColor xCN_DivMain">
        ...
        <div id="odiMenuTop" class ="xCN_AllBorderColor xCN_DivMainMenu">
            <div id="odiMenu" class="xCN_DivMenu" style="width:560px">
                ...
                <div id ="odiMenuPost" class="xCN_DivMenuPost xCN_DivDisplayNone" style="float:left;">
        ...
        <div id="odiSupplier" class ="">
                ...
                <div id="odiSplDetail" class ="xCN_AllBackgroundColor xCN_AllBorderColor xW_DivDetailSpl">
                    <div class =" xCN_AllBackgroundColorCustomer xW_DivSplMainCode xCN_AllBorderColor">
                        <div class ="xW_DivSplCaption xCN_AllMenuFontSize">
                                <label><%=ViewData("olaFTSplCode")%></label>
                        </div>                            
            ...
            <div  class="xW_DivBotton">
                <div style="float:right;margin-top:2px;">
                    <%--<input id="ocmNext" type="button" value="<%=ViewData("tNext")%>" 
                            class="xW_ButtonNext"
                ...
                <div id="odiDetailDT" class ="xW_DivDetailDTSub xCN_DivDisplayNone" >
                    <div class ="xCN_DivGridDetail">
                        <%--<div style="float:right">
                            <input id="ocmRefreshSpl" type="button" value="<%=ViewData("tRefresh")%>" 
                                class="xW_ButtonRefresh"
                                onclick="W_GETxRefreshSpl()" />
                            <button id="obnFilter" style="cursor:pointer; 
                                width:130; height:25px;" 
                                title='Refresh' 
                                onclick="W_GETxRefreshSpl()">
                                <img align="right" style="width:18px; height:18px;" 
                                    src='<%=Url.Content("~/Content/img/imgIcon16x16/Refresh_16x16.png")%>'alt="olaSearch" />
                                    Refresh
                            </button>
                        </div>--%>
        ...
        <div id="odiDocument" class ="xCN_DivDisplayNone">
            <div class="xW_DivDetailHD xCN_AllBackgroundColor xCN_AllBorderColor">
                ...
                <div class="xCN_AllBackgroundColor xCN_AllBorderColor xW_DivTabDetailSub1">
                    <div class=" xCN_DivTabDetail1Column1">
                        ...
                        <div id="odiCrdShow" class="xCN_DivCreditTermSub xCN_DivTabDisplay">
                    ...
                    <div class="xCN_DivTabDetail1Column3">                                    
                        ...
                        <div class ="xCN_DivTabDetail1InputData xCN_DivDisplayNone"><%--ซ่อนไว้ไม่ทำการแสดง--%>
                ...
                <div class="xCN_AllBackgroundColor xCN_AllBorderColor xW_DivTabDetailSub2">
                    ...
                    <div class="xCN_DivTabDetail2Column2">
                        <div class ="xCN_DivTabDetail2InputData xCN_DivDisplayNone"><%--ซ่อนไว้ไม่ทำการแสดง--%>
                        ...
                        <div class ="xCN_DivTabDetail2InputDatax xCN_DivDisplayNone"><%--ซ่อนไว้ไม่ทำการแสดง--%>
                            <div class="xCN_DivTabDetail2AreaCode">
                                <input type="text" 
                                    id="otbFTShpCode" 
                                    name="FTShpCode" 
                            ...
                            <div class="xCN_DivBrowData">
                                <a href="javascript:void();" onclick="W_GETxDataMaster('otbFTShpCode', 'otbFTShpName','ShpCode')" >
                                <img src="<%=ViewData("oimgBrowse")%>" 
                                        alt="<%=ViewData("olaCreate").ToString%>" 
                                        class="xCN_ImgBrowData"  /></a>         
                            </div>
                    ...
                    <div class="xW_DivTabDetail2Column3">
                        <div class ="xW_DivTabDetail2Caption">
                            <%=ViewData("olaFTXzhVATInOrEx")%>
                        </div>
                        <div class ="xCN_DivTabDetail2Caption">
                            <%=ViewData("olaFTXzhDstPaid")%>
                        </div>
                        <div class ="xW_DivTabDetail2AreaName">
                            <input type="text" 
                                    id="otbFTAreName" 
                                    name="otbFTAreName" 
                                    readonly="readonly" 
                        ...
                        <div class ="xCN_DivTabDetail2AreaName xCN_DivDisplayNone"><%--ซ่อนไว้ไม่ทำการแสดง--%>
                            <input type="text" 
                                    id="otbFTShpName" 
                                    name="otbFTShpName" 
                                    readonly="readonly" 
                    ...
                    <div class="xW_DivTabDetail2Column4">
                        <div class ="xW_DivTabDetail2InputData">
                            <%=Html.DropDownListFor(Function(model) model.FTXzhVATInOrEx, CType(ViewData("XihVATInOrEx"), SelectList), New With {.id = "ocbFTXzhVATInOrEx", .name = "FTXzhVATInOrEx", .class = "xW_SelectInDetail2", .disabled = "disabled"})%>
                        </div>
                        <div class ="xW_DivTabDetail2InputData">
                            <%=Html.DropDownListFor(Function(model) model.FTXzhDstPaid, CType(ViewData("XihDstPaid"), SelectList), New With {.id = "otbFTXzhDstPaid", .name = "FTXzhDstPaid", .class = "xW_SelectInDetail2"})%>
                        </div>
                        <div class ="xCN_DivTabDetail2InputData xCN_DivDisplayNone"><%--ซ่อนไว้ไม่ทำการแสดง--%>
                            <input type ="text" 
                                    id="otbFTXzhVehID" 
            ...
            <div class="xCN_AllBorderColor xW_DivDetailDT">
                <!-- Browse Document Pq -->
                <div id="odiBrwDocPq" class ="xW_DivDetailDTSub xW_DivMaginDT xCN_DivDisplayNone" >
                    <div class ="xCN_DivGridDetail">
                        <div style="height:auto">
                ...
                <!-- Browse Rate -->
                <div id="odiBrwRate" class ="xW_DivDetailDTSub xW_DivMaginDT xCN_DivDisplayNone" >
                    <div class ="xCN_DivGridDetail">
                        <div style="height:auto">
        ...
        <%------------------- Finish ---------------------------%>
        <div id="odiFinish" class="xCN_AllBackgroundColor xCN_AllBorderColor xW_DivDetailHD xCN_DivDisplayNone">
...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        var tW_ShwBrwSpl = '0'; //สถานะการเปิดค้นหา Spl *CH 25-03-2013
        var tW_ShwBrwRefDoc = '0'; //สถานะการเปิดค้นหาเอกสารขอซื้อ *CH 25-03-2013
        var tW_ShwBrwRate = '0'; //สถานะการเปิดค้นหาสกุลเงิน *CH 25-03-2013
        ...
        //Onload
//        window.onload = W_FRMxIniatialPo();
//        function W_FRMxIniatialPo() {
...
//        }
        ...
        function W_GETbRteDetail(pbOnload) {
            ...
            var tUrl = '<%=Url.Action("C_GETtRteDetail","cvcTACTPoHD") %>' + "?ptRteCode=" + tRteCode + "&ptDateTimeNow=" + tDataTimeNow;
        ...
        function W_GetApp() {
            ...
            var tUrl = '<%=Url.Action("C_GETxApp","cvcTACTPoHD") %>' + "?ptAppCode=" + tSpl + "&ptDateTimeNow=" + tDataTimeNow;
            oW_xmlHttp.open("GET", encodeURI(tUrl), false);
            oW_xmlHttp.send(null);
            var valueFis = oW_xmlHttp.responseText;
            var mytool_array = valueFis.split("|");
        ...
        //GET USER NAME & DEPART NAME
        function W_GETxUsrAndDptName() {
            W_CRExXMLHttpRequest();
            var tDataTimeNow = W_GETtDateTimeNow();
            var tUsrCode = $("#otbFTUsrCode").val();
            var tUrl = '<%=Url.Action("C_GETxUsrAndDptName","cvcTACTPoHD") %>' + "?ptUsrCode=" + tUsrCode + "&ptDateTimeNow=" + tDataTimeNow;
            oW_xmlHttp.open("GET", encodeURI(tUrl), false);
            oW_xmlHttp.send(null);
            var valueFis = oW_xmlHttp.responseText;
            var mytool_array = valueFis.split("|");
        ...
        function W_GETtDocNo() {
            ...
            var tUrl = '<%=Url.Action("C_GENtDocNo","cvcTACTPoHD") %>' + '?ptBchCode=' + tBchCode + '&ptDocType=' + tDocType + '&ptDateTimeNow=' + tDataTimeNow;
            oW_xmlHttp.open("GET", encodeURI(tUrl), false);
            oW_xmlHttp.send(null);
        ...
        function otbFTXzhDocNo_onblur() {
            ...
            if (W_CHKtHasDocNo() == true) {
                var tUrl = '<%=Url.Action("wTACTPo","cvcTACTPoHD") %>' + '?ptDocNo=' + tDocNo;
        ...
        function W_CHKbHasChangeDataDT() {
            try {
                ...
                var tUrl = '';
                tUrl += '<%=Url.Action("C_CHKtHasChangeDataDT","cvcTACTPoHD") %>';
        ...
        //เวลาปัจจุบัน เพื่อส่งไปหน้า controller
        ...
        function W_GetSplload(pbOnload) {
            ...
            W_CRExXMLHttpRequest();
            var tDataTimeNow = W_GETtDateTimeNow();
            var tUrl = '<%=Url.Action("C_GETxSpl","cvcTACTPoHD") %>' + "?ptSplCode=" + tSpl + "&ptDateTimeNow=" + tDataTimeNow;
            oW_xmlHttp.open("GET", encodeURI(tUrl), false);
            oW_xmlHttp.send(null);
            var valueFis = oW_xmlHttp.responseText;
            if (oW_xmlHttp.status != 200) {
        ...
        function W_GETxRefreshSpl() {
            W_GETxDataMaster('otbFTSplCode', 'otbSplName', 'Spl');
        }
            ...
            try {
                ...
                switch (ptCase.toUpperCase()) {
                    ...
                    case 'Rat'.toUpperCase():
                        ...
                        J016_SHWxNextPage(1, 'odiBrwDocPq', 'odiBrwRate', 'odiBrwArea');
                        break;
                    case 'Are'.toUpperCase():
                        switch (tW_ShwBrwArea) {
                            case '0':
                                ...
                                J016_SHWxNextPage(2, 'odiBrwDocPq', 'odiBrwRate', 'odiBrwArea');
                                break;
                            case '1':
                                tW_ShwBrwRefDoc = '0';
                                tW_ShwBrwArea = '0';
        ...
        function W_DATxBrowseRte() {
            try {
                //J003_SHWxWaiting();
                W_GETxDataMaster('otbFTRteCode', 'otbRateName', 'Rat'); //*CH 18-01-2013
                switch (tW_ShwBrwRate) {
                    case '0':
                        tW_ShwBrwRate = '1';
                        tW_ShwBrwRefDoc = '0';
                        tW_ShwBrwArea = '0';
                    ...
                    case '1':
                        ...
                        tW_ShwBrwArea = '0';
                        tW_ShwBrwRate = '0';
                        $('#odiBrwRate').addClass('xCN_DivDisplayNone');
                        break;
                }
            }
            catch (ex) {
        ...
        //OnChange Telerik.IntegerTextBox
        ...
        function W_SETxShowCreditTerm(pbOnload) {
            ...
            if (bCshChecked == true) {
                ...
                tCrTerm = document.getElementById('otbXFNXzhCrTerm').value;
            ...
            if (pbOnload != true) {
                ...
                //W_CALxDueDate();
                W_CALxDueDate(tCrTerm);
                W_CALxTnfDate();
            }
        }
        function W_CALxDueDate(pnCrTerm) {
            try {
                ...
                var tDate = W_SETtDueDate(pnCrTerm, $('#odtFDXzhDocDate').val());
                $("#odtFDXzhDueDate").val(tDate);
            }
            catch (ex) {
        ...
        function W_SHWxBrwRefDocWithNextBtn() {
            tW_ShwBrwRefDoc = '1';tW_ShwBrwRate = '0';tW_ShwBrwArea = '0';
            J016_SHWxNextPage(0, 'odiBrwDocPq', 'odiBrwRate', 'odiBrwArea'); 
        }
                ...
                if ($('#otbFTSplCode').val() != '') {
                    ...
                    switch (tW_ShwBrwRefDoc) {
                        ...
                        case '1':
                            ...
                            tW_ShwBrwRate = '0';
                            tW_ShwBrwArea = '0';
                            $('#odiBrwDocPq').addClass('xCN_DivDisplayNone');
                            break;
                    }
                }
            } catch (ex) {
        ...
        function W_ADDxRefDocData(ptDocNo, ptListSeq, ptReplace) {
            W_CRExXMLHttpRequest();
            var tDataTimeNow = W_GETtDateTimeNow();
            var tUrl = '<%=Url.Action("C_ADDxRefDocData","cvcTACTPoHD") %>' + "?ptRefDocNo=" + ptDocNo + '&ptListSeq=' + ptListSeq + '&ptReplace=' + ptReplace + '&ptDataTimeNow=' + tDataTimeNow;
            //alert(tUrl);
            oW_xmlHttp.open("GET", encodeURI(tUrl), false);
            oW_xmlHttp.send(null);
        ...
        function W_GETxPdtDetail() {
            ...
            var tUrl = '<%=Url.Action("C_GEToPdtDetail","cvcTACTPoHD") %>' + "?ptPdtCode=" + tModelPdt + "&ptDateTimeNow=" + tDataTimeNow;
            oW_xmlHttp.open("GET", encodeURI(tUrl), false);
            oW_xmlHttp.send(null);
            if (oW_xmlHttp.status == 200) {
                var valueFis = oW_xmlHttp.responseText;
        ...
        function W_ADDxAddPdtToGrid() {
            ...
            if (tPdtCode != null && tPdtCode != "") {
                ...
                if (J002_STRttrim(tPdtcode) == tW_PdtCodeBeFore && tSeq != '') {// && bAutoTab == true) {//edit
                    tUrl += '<%=Url.Action("C_DATxEditItem","cvcTACTPoHD") %>';
                    tParamSeq = '&ptSeq=' + tSeq;
                }
                else {
                    tUrl += '<%=Url.Action("C_DATxAddItem","cvcTACTPoHD") %>';
                }
        ...
        function W_DATxCalFooter() {
            ...
            var tUrl = '<%=Url.Action("C_DATtCalFooter","cvcTACTPoHD") %>';
            tUrl += "?pcDis=" + cDis;
            tUrl += "&pcChg=" + 0;
            tUrl += "&pcDis=" + cDis;
        ...
        function W_GETtGndTxt() {
            ...
            var tUrl = '<%=Url.Action("SP_GETtMoneyText","cvcTACTPoHD") %>' + "?ptDate=" + tDataTimeNow + "&ptMoney=" + tGrand;
            oW_xmlHttp.open("GET", encodeURI(tUrl), false);
            oW_xmlHttp.send(null);
            return oW_xmlHttp.responseText;
        }
        ...
        function W_DELxPdtItem() {
            ...
            var tDateTimeNow = W_GETtDateTimeNow();
            var tUrl = '<%=Url.Action("_DeleteAjaxEditing","cvcTACTPoHD") %>' + '?ptSeq=' + oEletent.value;
            tUrl += '&ptDateTimeNow=' + tDateTimeNow;
            W_CRExXMLHttpRequest();
            oW_xmlHttp.open("GET", encodeURI(tUrl), false);
            oW_xmlHttp.send(null);
        ...
        function W_SHWxUnitCombo() {
            ...
            var tUrl = '<%=Url.Action("C_GEToUnitDetail","cvcTACTPoHD") %>' + "?ptPdtCode=" + tModelPdt + "&ptDateTimeNow=" + tDataTimeNow;
            oW_xmlHttp.open("GET", encodeURI(tUrl), false);
        ...
        function W_SHWxNextPage(nPage) {
            if ($('#otbFTSplCode').val() != '') { J016_SHWxNextPage(nPage, 'odiSupplier', 'odiDocument', 'odiProduct'); }
        }
        ...
        function W_CHKtHasDocNo(ptDocNo) {
            var tDateTimeNow = W_GETtDateTimeNow();
            var tDocNo = document.getElementById("otbFTXzhDocNo").value;
            var tUrl = '<%=Url.Action("C_CHKtHasDocNo","cvcTACTPoHD") %>' + '?ptDocNo=' + tDocNo + '&ptDateTimeNow=' + tDateTimeNow;
            W_CRExXMLHttpRequest();
            oW_xmlHttp.open("GET", encodeURI(tUrl), false);
            oW_xmlHttp.send(null);
        ...
        function W_LODxReloadData(ptDocNo) {
            var tUrl = '<%=Url.Action("wApvTACTPo","cvcTACTPoHD") %>' + '?ptDocNo=' + ptDocNo;
            window.location = tUrl;
        }
        //บันทึกเอกสาร
        function W_DATxSaveDocument(pbNoReload) {
            try {
                ...
                var url = '<%= Url.Action("C_DATxSaveDocument", "cvcTACTPoHD") %>';
