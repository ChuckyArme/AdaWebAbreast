...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        ViewData("olaGenCode") = AdaWebPos.My.Resources.resLCcvcBank.olaGenCode
...
//            return !(window.event && window.event.keyCode == 13);
    ...
    function W_FRMxGenCode() {
        J001_GETtAutoGenCode('cvcBank', 'C_Create_GetAutoCode', document.getElementById('FTBnkCode'));
        J002_SETxReadOnly("FTBnkCode", false);
        document.getElementById("FTBnkCode").onkeydown = function() { return true; };

        var tCode = document.getElementById('FTBnkCode').value;
        if (tCode == "Adasoft.Abreast.MaxValue") {
            document.getElementById('FTBnkCode').value = "";
    ...
    function W_FRMxSaveDocument() {
        ...
        if (bAllow == false) {
            ...
            document.getElementById("wBank").submit();
        }
    }
    ...
    <%=""%>
    <% Using Html.BeginForm("C_Create", "cvcBank", FormMethod.Post, New With {.collection = "cmlBank", .ptValue = "Bank_Create", .name = "Bank_Create", .id = "wBank"})%>
        <%-------------------ส่วนรายละเอียด-------------------------%>  
