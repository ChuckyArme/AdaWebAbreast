...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        ViewData("olaGenCode") = AdaWebPos.My.Resources.resLCcvcSaleperson.olaGenCode
...
<script type="text/javascript">
    ...
    function W_FRMxGenCode() {
        ...
        document.getElementById("otbFTSpnCode").onkeydown = function() { return true; };
    ...
    function W_FRMxSaveDocument() {
        ...
        {
            document.wSalePerson.submit();
        }       
    }
    
</script>

<% Using Html.BeginForm("C_Create", "cvcSaleperson", FormMethod.Post, New With {.collection = "cmlSaleperson", .ptValue = "wSalePerson", .name = "wSalePerson"})%>
